...
// Mon Jun 25 15:00:30 2018 by ROOT version 5.34/30
// from TTree miniDst/miniDst
// found on file: ../../54GeV/picoDst/miniTree/rootfiles_PicoDst/AF8BE685DC62E95B8D1158145E66157E_2387.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../54GeV/picoDst/miniTree/rootfiles_PicoDst/AF8BE685DC62E95B8D1158145E66157E_2387.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../54GeV/picoDst/miniTree/rootfiles_PicoDst/AF8BE685DC62E95B8D1158145E66157E_2387.root");
      }
